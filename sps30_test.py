...
#                print("Temp: ", temperature, "c Humidity: ", humidity,"%")
                DBSETUP.ganacheLogger(float(typical_partical_size), "Typical Particle Size", "Desc.","Desc. DEsc.","MAC_Address_Addy_Nadkarni", "SPS30", "Sensiron")  
                DBSETUP.ganacheLogger(float(pm1), "PM1.0", "Desc","DEsc","MAC_Address_Addy_Nadkarni", "SPS30", "Sensiron")
