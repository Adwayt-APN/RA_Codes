...
while True:
  ...
  print("%: ", hum)
  time.sleep(1)	
  DBSETUP.ganacheLogger(float(temp), "Temperature_GO_1", "C", "MAC_Add_Addy_Rpi_Office_1", "unit_descrip_OFFICE_1", "SHTC3_OFFICE_1", "Sensirion")
  ...
  DBSETUP.ganacheLogger(float(hum), "Humidity_GO_1", "%", "MAC_Add_Addy_Rpi_Office_1", "unit_descrip_OFFICE_1", "SHTC3_OFFICE_1", "Sensirion")
