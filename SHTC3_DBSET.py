...
while True:
  ...
  print("%: ", hum)
  time.sleep(1)	
  DBSETUP.ganacheLogger(float(temp), "Temperature_Office_1", "C", "MAC_Add_Addy_Rpi_Office_1", "co2_Office_1", "T6713_Office_1", "Telaire")
  ...
  DBSETUP.ganacheLogger(float(hum), "Humidity_Office_1", "%", "MAC_Add_Addy_Rpi_Office_1", "co2_Office_1", "T6713_Office_1", "Telaire")
